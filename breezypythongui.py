...
class EasyRadiobuttonGroup(Tkinter.Frame):
    ...
    def __init__(self, parent, row, column, rowspan, columnspan, orient):
        ...
        self.grid(row = row, column = column,
                  rowspan = rowspan, columnspan = columnspan,
                  sticky = N+S+E+W)
        self._commonVar = Tkinter.StringVar() ###!!! deleted "value = ''" !!!
        self._buttons = dict()
        self._orient = orient
...
class EasyMenubutton(Tkinter.Menubutton):
    ...
    def __init__(self, menuBar, text, state):
        ...
        self.menu = Tkinter.Menu(self, tearoff = 0) # !!! No tear-off menu allowed - tearoff = 0 instead of 1
        self["menu"] = self.menu
...
class EasyCanvas(Tkinter.Canvas):
    ...
    def __init__(self, parent, width = None, height = None,
        ...
        #self.bind("<Double-Button-3>", self.mouseRDoubleClicked)
    ...
    def mouseRPressed(self, event):
        """Triggered when the right mouse button is
